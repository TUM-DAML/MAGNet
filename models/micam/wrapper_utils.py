...
from models.micam.src.model.MiCaM_VAE import MiCaM
from models.micam.src.model.mydataclass import ModelParams, Paths
from models.micam.src.train import train
