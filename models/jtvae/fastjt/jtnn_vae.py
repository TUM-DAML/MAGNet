...
from baselines.jtvae.fastjt.chemutils import *
from baselines.jtvae.fastjt.datautils import MolTreeFolder, tensorize
from baselines.jtvae.fastjt.jtmpn import JTMPN
from baselines.jtvae.fastjt.jtnn_dec import JTNNDecoder
from baselines.jtvae.fastjt.jtnn_enc import JTNNEncoder
from baselines.jtvae.fastjt.mol_tree import MolTree
from baselines.jtvae.fastjt.mpn import MPN
from baselines.jtvae.fastjt.nnutils import create_var


class JTNNVAE(pl.LightningModule):
    def __init__(
        self,
        vocab=None,
        hidden_size=450,
    ...
    def reconstruct(self, smiles, prob_decode=False):
        ...
        tree_vec, _ = self.rsample(tree_vec, self.T_mean, self.T_var)
        mol_vec, _ = self.rsample(mol_vec, self.G_mean, self.G_var)
    ...
    def training_step(self, x_batch, batch_id):
        ...
        loss = word_loss + topo_loss + assm_loss + self.beta * kl_div
