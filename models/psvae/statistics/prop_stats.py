...
from models.psvae.evaluation.utils import (
    PROPS,
    get_normalized_property_scores,
    restore_property_scores,
)
...
def parse():
    ...
    parser.add_argument("--cpus", type=int, default=os.cpu_count(), help="Number of cpu cores to parallel calculation")
...
def main(args):
    ...
    progs = [
        pool.apply_async(get_props, args=(smiles[i : min(len(smiles), i + size)], [func for _, func in addition_props]))
