...
def parse():
    ...
    parser.add_argument("--data", type=str, required=True, help="Path to origin dataset")
    parser.add_argument("--valid_ratio", type=float, required=True, help="Ratio of validation set")
    parser.add_argument("--test_ratio", type=float, required=True, help="Ratio of test set")
