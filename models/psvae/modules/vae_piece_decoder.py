...
from models.psvae.modules.common_nn import MLP
from models.psvae.modules.encoder import Encoder
from models.psvae.utils.chem_utils import (
    cnt_atom,
    cycle_check,
    smiles2molecule,
    valence_check,
...
class VAEPieceDecoder(nn.Module):
    ...
    def __init__(
        ...
        self.graph_embedding = Encoder(node_dim, num_edge_type, node_hidden_dim, dim_out=1, t=t)  # dim_out is of no use
        # edge link predictor
