...
from baselines.moler.molecule_generation.chem.motif_utils import MotifAnnotation, MotifAtomAnnotation
from baselines.moler.molecule_generation.chem.rdkit_helpers import initialise_atom_from_symbol
from baselines.moler.molecule_generation.chem.valence_constraints import _max_valence_for_single_node
...
def get_node_edges(
    ...
    locked_edges = [
        typed_edge for typed_edge in candidate_edges if node_states[typed_edge.target] is NodeState.LOCKED
    ]
    return locked_edges
