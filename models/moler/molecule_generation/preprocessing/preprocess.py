...
from models.moler.molecule_generation.preprocessing.graph_sample import GraphSample
...
def preprocess_jsonl_files(
    ...
    if not output_metadata_path.exists():
        ...
        assert input_metadata_path.exists(), f"Metadata file {metadata_filename} does not exist in {jsonl_directory}"
