...
from baselines.moler.molecule_generation.dataset.trace_sample import TraceStep
from baselines.moler.molecule_generation.chem.motif_utils import get_motif_type_to_node_type_index_map
...
class JSONLMoLeRTraceDataset(JSONLAbstractTraceDataset):
    ...
    def _include_trace_step_in_batch(self, trace_step: TraceStep) -> bool:
        ...
        if trace_step.correct_node_type_choices is not None and "C" not in trace_step.correct_node_type_choices:
