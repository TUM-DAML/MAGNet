...
from models.moler.molecule_generation.dataset.trace_dataset import (
    TraceDataset,
    TraceSample,
)
...
class InMemoryTraceDataset(TraceDataset):
    def __init__(
        ...
        self._node_type_to_index_map = {typ: idx for idx, typ in self._node_type_index_to_string.items()}
    ...
    def load_data_from_list(self, datapoints: List[TraceSample], target_fold: DataFold = DataFold.TEST):
