...
from baselines.moler.molecule_generation.dataset.trace_dataset import DataFold
from baselines.moler.molecule_generation.layers.moler_decoder import MoLeRDecoderState
from baselines.moler.molecule_generation.layers.moler_decoder import (
...
from baselines.moler.molecule_generation.models.moler_vae import MoLeRVaeOutput
from baselines.moler.molecule_generation.utils.model_utils import load_vae_model_and_dataset
from baselines.moler.molecule_generation.wrapper import VaeWrapper
        ...
        for step_info in decoder_states.generation_steps:
            if isinstance(step_info, MoleculeGenerationAttachmentPointChoiceInfo):
                ...
                self.render_atom_data(
                    ...
                    choice_descr=(
                        "next addition to partial molecule" if first_step_done else "initial starting point"
                    ),
                )
            else:
