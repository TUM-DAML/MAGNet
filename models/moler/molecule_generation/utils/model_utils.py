...
from baselines.moler.molecule_generation.dataset.in_memory_trace_dataset import InMemoryTraceDataset
...
def load_vae_model_and_dataset(
    ...
    trained_model_path = str(trained_model_path)  # get_model_file_path takes `str` as input, so we need to cast it
