...
from models.moler.molecule_generation import VaeWrapper
...
def save_smiles_embeddings(model_dir: str, smiles_path: str, output_path: str, **model_kwargs) -> None:
...
def get_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("SMILES_PATH", type=str, help="Path to a *.smiles file containing SMILES strings to encode.")
    parser.add_argument(
        "OUTPUT_PATH",
        type=str,
