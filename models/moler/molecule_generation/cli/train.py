...
from models.moler.molecule_generation.dataset.jsonl_abstract_trace_dataset import (
    JSONLAbstractTraceDataset,
)
from models.moler.molecule_generation.dataset.jsonl_cgvae_trace_dataset import (
    JSONLCGVAETraceDataset,
)
from models.moler.molecule_generation.dataset.jsonl_moler_trace_dataset import (
    JSONLMoLeRTraceDataset,
)
from models.moler.molecule_generation.models.cgvae import CGVAE
...
from models.moler.molecule_generation.utils.cli_utils import (
    setup_logging,
...
def run_from_args(args: argparse.Namespace) -> Tuple[str, str, str]:
    ...
    if not isinstance(loaded_model_dataset[1], (CGVAE, MoLeRVae, MoLeRGenerator)):
        raise ValueError(f"This training script can only work with CGVAE/MoLeR, " f"but got {loaded_model_dataset[1]}!")
