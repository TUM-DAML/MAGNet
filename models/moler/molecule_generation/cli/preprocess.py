...
import models.moler.molecule_generation.preprocessing.generation_order as gen_order
from models.moler.molecule_generation.chem.molecule_dataset_utils import (
    featurise_smiles_datapoints,
)
from models.moler.molecule_generation.preprocessing.preprocess import (
...
from models.moler.molecule_generation.utils.preprocessing_utils import save_data
...
def get_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("OUTPUT_DIR", type=str, help="Directory which will hold the resulting preprocessed data.")
    parser.add_argument("TRACE_DIR", type=str, help="Directory in which we want to save the trace datasets.")
    parser.add_argument(
        "--num-datapoints",
        dest="num_datapoints",
        type=int,
    ...
    parser.add_argument("--seed", dest="random_seed", type=int, default=0, help="Random seed to use.")
...
def run_smiles_preprocessing(
    *,
    ...
    if done_featurising:
        ...
        train_datapoints, valid_datapoints, test_datapoints = load_smiles_data(input_dir, n_datapoints=num_datapoints)
