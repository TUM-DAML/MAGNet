...
from baselines.moler.molecule_generation.cli import encode, preprocess, sample, train, visualise
from baselines.moler.molecule_generation.utils.cli_utils import setup_logging, supress_tensorflow_warnings


def main():
    parser = argparse.ArgumentParser(description="Training, inference and visualization CLI for the MoLeR model.")
