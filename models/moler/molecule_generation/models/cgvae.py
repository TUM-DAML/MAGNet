...
from baselines.moler.molecule_generation.dataset.trace_dataset import TraceDataset
from baselines.moler.molecule_generation.layers.cgvae_decoder import CGVAEDecoder, CGVAEDecoderInput
from baselines.moler.molecule_generation.layers.graph_property_predictor import (
    GraphPropertyPredictor,
    GraphPropertyPredictorInput,
)
from baselines.moler.molecule_generation.utils.training_utils import get_class_balancing_weights
from baselines.moler.molecule_generation.chem.atom_feature_utils import AtomFeatureExtractor
from baselines.moler.molecule_generation.utils.epoch_metrics_logger import EpochMetricsLogger
...
class CGVAE(GraphTaskModel):
    ...
    def get_default_hyperparameters(cls, mp_style: Optional[str] = None) -> Dict[str, Any]:
        ...
        decoder_hypers = {
            cls.decoder_prefix() + k: v for k, v in CGVAEDecoder.get_default_params(mp_style).items()
        }
