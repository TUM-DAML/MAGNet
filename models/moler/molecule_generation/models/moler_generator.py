...
from baselines.moler.molecule_generation.layers.moler_decoder import MoLeRDecoderOutput
...
class MoLeRGenerator(MoLeRBaseModel):
    ...
    def compute_task_output(
        ...
        final_node_representations: Optional[Any],  # Ignored: here for consistency of interface with moler_vae
        training: bool,
    ) -> MoLeRGeneratorOutput:
        molecule_representations = tf.zeros((batch_features["num_partial_graphs_in_batch"], self.latent_dim))
        ...
        per_graph_molecule_representations = tf.zeros((batch_features["num_graphs_in_batch"], self.latent_dim))
