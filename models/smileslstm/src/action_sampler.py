...
from models.smileslstm.src.rnn_utils import rnn_start_token_vector
...
class ActionSampler:
    ...
    def __init__(self, max_batch_size, max_seq_length, device, distribution_cls: Type[Distribution] = None) -> None:
        """
        Args:
